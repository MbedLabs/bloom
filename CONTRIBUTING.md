# Contributing to Bloom by EmbedLabs

Thank you for helping improve Bloom.

## License status

Bloom is **source-available**, not Open Source under the Open Source Definition. Use of the software is governed by the [EmbedLabs Source Available License](LICENSE).

The separate `bud-runner` and `budtestlibrary` Python packages remain independent AGPL-3.0-only open-source projects. Their licences do not change the licence of the Bloom application.

## Contributor License Agreement

Contributions to the official Bloom repository require acceptance of [CLA.md](CLA.md), version 1.0 or a later clearly identified version.
