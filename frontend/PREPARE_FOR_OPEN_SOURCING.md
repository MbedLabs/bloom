...
Bloom is currently using a development-first deployment model similar in spirit to the internal Fleet Monitoring setup.
...
- Show the running app version clearly in the UI, including on login screens.
...
If a new image is running, it should be obvious from the version visible in the app.
