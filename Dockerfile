...
LABEL org.opencontainers.image.licenses="LicenseRef-EmbedLabs-Source-Available-1.0" \
      org.opencontainers.image.source="https://github.com/MbedLabs/bloom"
...
RUN useradd -m appuser \
    && mkdir -p /app/attachments \
        /run/nginx /var/lib/nginx /var/log/nginx /var/log/supervisor \
    ...
    && ln -s /run/bloom/runtime-config.js /var/www/app/runtime-config.js
...
# Generous start-period covers first-boot migrations before probing begins.
