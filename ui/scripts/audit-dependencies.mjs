...
// processing. Bloom is a browser-only Vite SPA: it does not enable RSC or
// expose server actions. React Router 8.3 fixes the advisory but currently
// requires React >=19.2.7 and Node >=22.22. Keep this one narrow exception
// until a patched 7.x is published or the application completes that migration.
