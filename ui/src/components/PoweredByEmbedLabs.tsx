  ...
  return (
    ...
    >
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="block w-full max-w-full overflow-hidden whitespace-nowrap text-xs text-violet-300/50 hover:text-violet-200 transition-colors"
      >
        Powered by EmbedLabs
      </a>
      <p className="text-xs text-violet-300/30 mt-1">
        v{version}
      </p>
    </div>
  )
