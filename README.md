...
2. Set `BLOOM_ENV=production`, the admin variables above, and `AUTO_SEED_ADMIN=true`.
...
5. Sign in as that admin and create invitation-based user accounts for maintainers and externals.
