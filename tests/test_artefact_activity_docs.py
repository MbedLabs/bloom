...
@pytest.fixture
def project_id(api_client: TestClient, auth_headers: dict[str, str], project_prefix: str) -> int:
    response = api_client.post(
        "/api/projects",
        headers=auth_headers,
        json={"name": f"Activity Docs Project {project_prefix}", "prefix": project_prefix},
    )
